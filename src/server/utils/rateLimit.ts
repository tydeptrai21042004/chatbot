import { consumeSharedRateLimit } from "../data/store";
...
export async function checkSharedRateLimit(key:string,limit=30,windowMs=60_000){return (await consumeSharedRateLimit(key,limit,windowMs))??checkRateLimit(key,limit,windowMs);}
