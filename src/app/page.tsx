  ...
  return (
    <main className="landing-page">
      <header className="landing-nav">
        <Link className="brand" href="/" aria-label="Trang chủ Bạn đồng hành học đường">
          <span className="brand-mark" aria-hidden>●</span>
          <span>Bạn đồng hành học đường</span>
        </Link>
      ...
      <section className="landing-hero">
        ...
        <div className="hero-visual reveal-scale" aria-hidden>
          ...
          <div className="conversation-card card-main">
            <div className="conversation-head"><span className="avatar-dot">A</span><div><strong>Bạn đồng hành học đường</strong><small>Đang đồng hành cùng bạn</small></div><span className="online-dot" /></div>
      ...
      <footer className="landing-footer"><div className="brand"><span className="brand-mark" aria-hidden>●</span><span>Bạn đồng hành học đường</span></div><p>Nền tảng hỗ trợ tinh thần học đường dành cho học sinh Việt Nam.</p></footer>
